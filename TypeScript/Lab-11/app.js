...
var GetRestaurantList = function (restaurants) {
    ...
    restaurants.forEach(function (rst, index) {
        console.log("Restaurant ID: ".concat(index + 1, " Name:").concat(rst.Name, "  Address:  ").concat(rst.Address, " Phone: ").concat(rst.Phone, "  Restaurant Type: ").concat(rst.Type));
    });
};
